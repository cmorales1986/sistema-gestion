...
type Articulo       = { id: string; codigo: string | null; nombre: string; unidadMedida: string; impuestoId: string | null; precioCompra: number | null }
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">
              ...
              <div className="relative">
                <select value={cabecera.proveedorId} onChange={e => setCabecera({ ...cabecera, proveedorId: e.target.value })}
            ...
            <div>
              ...
              <input value={cabecera.nroComprobante} onChange={e => setCabecera({ ...cabecera, nroComprobante: e.target.value })}
            ...
            {monedaSeleccionada && !monedaSeleccionada.principal && (
              <div>
                ...
                <input type="number" value={cabecera.tipoCambio} onChange={e => setCabecera({ ...cabecera, tipoCambio: parseFloat(e.target.value) || 1 })}
                  placeholder="7500"
                  className="w-full px-3 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:border-transparent" />
              </div>
            )}
