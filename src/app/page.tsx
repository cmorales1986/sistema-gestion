      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features"  className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Funciones</a>
            <a href="#precios"   className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Precios</a>
            <a href="#seguridad" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Seguridad</a>
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-[#1E3A5F] via-[#1a4a7a] to-[#2E6DA4]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="#features"
              className="w-full sm:w-auto px-8 py-4 rounded-xl border border-white/30 text-white font-medium text-base hover:bg-white/10 transition-colors">
              Ver funciones
            </a>
          </div>
        ...
        <div className="max-w-3xl mx-auto mt-16 grid grid-cols-3 gap-4">
          {[
            { valor: '30 días', label: 'de prueba gratis' },
            ...
            {[
              {
                ...
                desc: 'Registrá facturas de compra, controlá pagos y llevá el historial de tus proveedores al día.',
              },
              {
                icon: '💰',
                titulo: 'Ventas y clientes',
                desc: 'Emitíl facturas, controlá cobros y conocé en tiempo real cuánto te deben tus clientes.',
              },
              {
                icon: '📦',
                titulo: 'Stock e inventario',
                desc: 'El stock se actualiza automáticamente con cada compra y venta. Alertas cuando hay poco stock.',
              },
              {
                icon: '📊',
                titulo: 'Reportes completos',
                desc: 'Cuentas por cobrar, cuentas por pagar, resultado del mes y inventario valorizado.',
              },
              {
                icon: '🏢',
                titulo: 'Multi-empresa',
                desc: 'Manejá varias empresas desde una sola cuenta. Ideal para contadores y grupos empresariales.',
              },
              {
                icon: '🧾',
                titulo: 'Timbrado SET',
                desc: 'Configurá tu timbrado de la SET con numeración automática para tus facturas de venta.',
              },
              {
                icon: '💳',
                titulo: 'Pagos y cobros',
                desc: 'Registrá pagos en efectivo, cheque, transferencia o tarjeta. Saldo actualizado al instante.',
              },
              {
                icon: '📱',
                titulo: 'Acceso desde cualquier lugar',
                desc: 'Sistema 100% online. Accedé desde tu celular, tablet o computadora sin instalar nada.',
              },
              {
                icon: '📤',
                titulo: 'Exportar a Excel',
                desc: 'Exportá todos tus reportes a Excel con un clic para compartir o analizar en detalle.',
              },
            ].map(f => (
              <div key={f.titulo} className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-[#2E6DA4] hover:shadow-md transition-all">
      ...
      <section id="seguridad" className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2E6DA4] rounded-2xl p-8 text-white">
      ...
      <section id="precios" className="py-20 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {/* Básico */}
            <div className="bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-md transition-all">
            ...
            {/* Pro */}
            <div className="bg-[#1E3A5F] rounded-2xl border border-[#1E3A5F] p-8 hover:shadow-xl transition-all relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={f.q} className="group bg-gray-50 rounded-xl border border-gray-200 overflow-hidden">
      ...
      <section id="contacto" className="py-20 px-6 bg-gradient-to-br from-[#1E3A5F] to-[#2E6DA4]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/70 mb-8">
            Empezá hoy con 30 días gratis. Sin tarjeta de crédito.
          </p>
          ...
          <p className="text-white/40 text-xs">
            ...
            <a href="mailto:christtian.morales@gmail.com" className="text-white/60 hover:text-white underline">
              christtian.morales@gmail.com
            </a>
          </p>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="mailto:christtian.morales@gmail.com"
              className="text-gray-400 hover:text-white text-sm transition-colors">
              Email
            </a>
